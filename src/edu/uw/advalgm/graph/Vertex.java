...
public class Vertex {
	 ...
	 * 
	 * @param data
	 *            an object to be associated with this vertex
	 * @param name
	 *            a name to be associated with this vertex
	 */
	public Vertex(Object data, Object name) {
		this.data = data;
		this.name = name;
		this.incidentEdgeList = new ArrayList();
	}
	...
	public String toString() {
		return "[ " + name.toString() + ", " + Arrays.toString(incidentEdgeList.toArray()) + " ]";
	}
}

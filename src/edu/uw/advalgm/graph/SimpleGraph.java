...
public class SimpleGraph {
	 ...
	 * 
	 * @param data
	 *            an object to be associated with the new vertex
	 * @param name
	 *            a name to be associated with the new vertex
	 ...
	 * @param data
	 *            data to be associated with the new edge
	 * @param name
	 *            name to be associated with the new edge
	...
	/**
	 * Given a vertex and an edge, if the vertex is one of the endpoints of the
	 * edge, return the other endpoint of the edge. Otherwise, return null.
	 * 
	 * @param v
	 *            a vertex
	 * @param e
	 *            an edge
	 * @returns the other endpoint of the edge (or null, if v is not an endpoint
	 *          of e)
	 */

...
/**
 * Class that represents an edge in a graph. An object (usually some sort of
 * data) can be associated with the edge.
 * 
...
public class Edge {
	 ...
	 * @param data
	 *            data to be associated with this edge
	 * @param name
	 *            a name to be associated with this edge
	 */
	...
	public String toString() {
		return "[" + v1.getName().toString() + ", " + v2.getName().toString() + ", " + name.toString() + "]";
	}
}
